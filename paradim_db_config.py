...
class ParadimConfig(Config, config_key):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--configkey', required=False,
                        metavar="CasJobs config ID to query",
                        help='key to use to access config')
    ...
    # Configurations
    if args.command == "train":
        config = ParadimConfig(config_key = args.configkey)
    else:
